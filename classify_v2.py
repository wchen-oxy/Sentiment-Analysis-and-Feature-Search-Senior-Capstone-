            ...
            for sentence in review.sentences:
                ...
                for token in doc:
                    ...
                    if token.pos_ == "NOUN" or token.pos_ == "ADJ" or token.pos_ == "ADV" or token.pos_ == "PROPN":
                        if token.dep_ == "nsubj":
                            result = ("nsubj:" + str(token))
                            # print(result)
                            if token.is_stop != "True":
                                placeholder.append(result)
                        if token.dep_ == "dobj":
                            result = ("dobj:" + str(token))
                            # print(result)
                            if token.is_stop != "True":
                                placeholder.append(result)
                        if token.dep_ == "compound":
                            result = ("compound:" + str(token))
                            # print(result)
                            if token.is_stop != "True":
                                placeholder.append(result)
                        if token.dep_ == "ROOT":
                            result = ("Root:" + str(token))
                            # print(result)
                            if token.is_stop != "True":
                                placeholder.append(result)
                        if token.dep_ == "advmod":
                            if token.tag_ != "WRB":
                                result = ("advmod:" + str(token))
                            # print(result)
                                if token.is_stop != "True":
                                    placeholder.append(result)
                        if token.dep_ == "amod":
                            result = ("amod:" + str(token))
                            # print(result)
                            if token.is_stop != "True":
                                placeholder.append(result)
                        if token.dep_ == "attr":
                            result = ("attr:" + str(token))
                            # print(result)
                            if token.is_stop != "True":
                                placeholder.append(result)
                        if token.dep_ == "acomp":
                            result = ("acomp:" + str(token))
                            # print(result)
                            if token.is_stop != "True":
                                placeholder.append(result)
                        if token.dep_ == "pobj":
                            result = ("pobj:" + str(token))
                            # print(result)
                            if token.is_stop != "True":
                                if token.text != "pm":
                                    placeholder.append(result)
                        if token.dep_ == "nsubjpass":
                            result = ("nsubjpass:" + str(token))
                            # print(result)
                            if token.is_stop != "True":
                                placeholder.append(result)
                        if token.dep_ == "":
                            ...
                            if token.is_stop != "True":
                                placeholder.append(result)
                        if token.dep_ == "conj":
                            result = ("conj:" + str(token))
                            # print(result)
                            if token.is_stop != "True":
                                placeholder.append(result)
                        if token.dep_ == "npadvmod":
                            result = ("npadvmod:" + str(token))
                            # print(result)
                            if token.is_stop != "True":
                                placeholder.append(result)
                        if token.dep_ == "cconj":
                            result = ("cconj:" + str(token))
                            # print(result)
                            if token.is_stop != "True":
